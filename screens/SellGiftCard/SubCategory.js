...
const SubCategory = ({ isModalVisible, toggleModal, handleSubCategorySelection }) => {
    return (
        <Modal
        ...
        >
            <ShortModalContainer>
                <ShortModal>
                        <ShortModalHeading>
                    <ShortModalTitle>Select type</ShortModalTitle>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <TouchableOpacity onPress={() => handleSubCategorySelection(item.name)}>
                                <ShortModalItemContainer>
                                    {item.image && (
                                        <Image
